...
int __libc_accept(int s, struct sockaddr *addr, socklen_t * addrlen) __attribute__((weak));
//int accept(int s, struct sockaddr *addr, socklen_t * addrlen) __attribute__((weak));
...
int bind(int sockfd, const struct sockaddr *myaddr, socklen_t addrlen) __attribute__((weak));
...
int __libc_connect(int sockfd, const struct sockaddr *saddr, socklen_t addrlen) __attribute__((weak));
...
int getsockname(int sockfd, struct sockaddr *addr, socklen_t * paddrlen) __attribute__((weak));
...
ssize_t __libc_recv(int sockfd, __ptr_t buffer, size_t len, int flags) __attribute__((weak));
...
int socket(int family, int type, int protocol)  __attribute__((weak)); 
