...
int __libc_select(int n, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, struct timeval *timeout)  __attribute__((weak));
...
{
	printf("You are still in the original select function!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
