...
static void init_exe_env(void)
{

memset(__exe_env.fds, 0, sizeof(__exe_env.fds));
__exe_env.fds[0] = (exe_file_t){ 0, eOpen | eReadable, 0, 0};
__exe_env.fds[1] = (exe_file_t) { 1, eOpen | eWriteable, 0, 0}; 
__exe_env.fds[2] = (exe_file_t) { 2, eOpen | eWriteable, 0, 0};

__exe_env.umask= 022;
__exe_env.version=0;
__exe_env.save_all_writes=0;

memset(__exe_env.sct, 0, sizeof(__exe_env.sct));
}
